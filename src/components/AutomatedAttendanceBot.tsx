...
const AutomatedAttendanceBot: React.FC = () => {
  ...
  // Function to generate detailed attendance summary
  const generateDetailedSummary = async () => {
    try {
      ...
      return `*Dutch Trails Report*\n` +
        ...
        `───────────────────\n\n` +
        `📊 *ATTENDANCE SUMMARY*\n` +
        `• Total Staff: ${summary.totalEmployees}\n` +
        `• Present: ${summary.presentCount} ✅\n` +
        `• Late Arrivals: ${summary.lateCount} ⏰\n` +
        `• Absent: ${summary.absentCount} ❌\n` +
        `• Early Departures: ${summary.checkedOutCount} 🏃\n\n` +
        `📈 *PERFORMANCE METRICS*\n` +
        ...
        `${summary.checkedOutCount > 0 ? `• Early Departures: ${summary.checkedOutCount} staff\n` : ''}` +
